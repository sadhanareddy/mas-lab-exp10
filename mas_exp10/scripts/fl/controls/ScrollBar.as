package fl.controls
{
   ...
   public class ScrollBar extends UIComponent
   {
      ...
      override public function set enabled(param1:Boolean) : void
      {
         ...
         downArrow.enabled = track.enabled = thumb.enabled = upArrow.enabled = Boolean(enabled) && _maxScrollPosition > _minScrollPosition;
         updateThumb();
      }
      ...
      protected function updateThumb() : void
      {
         ...
         if(track.height <= 12 || _maxScrollPosition <= _minScrollPosition || (_loc1_ == 0 || Boolean(isNaN(_loc1_))))
         {
            thumb.height = 12;
            thumb.visible = false;
         }
